export const profile = {
 ...
 description: ['생성물을 이해하고 설명하며,', '책임질 수 있는 결과로 만드는 AI-native 개발자입니다.'],
 role: ['AI Agent /', 'LLM Application Developer'],
};
export const projects = [
 { name:'FOWOCO', summary:'외국인 근로자의 다양한 문의를 다루는 Language Assistant를 설계했습니다.', role:'Language Assistant 서브그래프 설계·구현 / HWPX MCP 구현 / 팀 협업 조율', status:'구현 근거 확인 · 실행·테스트는 과거 PR 보고', href:'https://github.com/fowoco/ai', linkLabel:'저장소 보기', visualTitle:'핵심 정보를 지키는 검색 흐름', steps:[['검색 관점 구성','핵심 정보 누락 검사'],['Hybrid Search','Dense + Sparse'],['RRF → Re-ranking','후보 결합과 선별']] },
