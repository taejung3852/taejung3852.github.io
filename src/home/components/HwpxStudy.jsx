...
export default function HwpxStudy(){
 ...
 <section id="analyze" className="fw-section">
  ...
  <div className="fw-findings">
   <article className="fw-cost"><span className="fw-kicker">한 번에 맡기면</span><strong>약 1분</strong><h3>대신 매번 같은 결과가 아닙니다</h3><p>사용자는 문서가 다 만들어진 뒤에야 내용을 봅니다. 잘못 들어간 칸도 그때 드러납니다.</p></article>
   <article className="fw-benefit"><span className="fw-kicker">확인을 거치면</span><strong>3분 25초</strong><h3>대신 매번 같은 절차를 밟습니다</h3><p>자리 확인 7회 · 편집 계획 20건 · 셀 단위 대조. 사용자가 답한 시간을 포함한 실측값입니다.</p></article>
  </div>
 </section>
 ...
 <section id="result" className="fw-section">
  ...
  <p className="fw-note">02에서 문제로 꼽았던 자리도 나뉘었습니다 — 같은 문구의 전화번호 칸이 여럿인데 <strong>휴대전화와 근무처 전화번호가 각기 다른 행에 들어갔습니다.</strong></p>
  ...
  <p className="fw-takeaway">두 오류 모두 결과물을 눈으로 봐서는 찾기 어렵습니다. 셀 단위로 맞춰 봐야 드러납니다.</p>
