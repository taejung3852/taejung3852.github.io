...
export default function FowocoStudy(){
 ...
 <section className="study-scene" aria-labelledby="search-title">
  ...
  <div className="study-layout"><figure className="study-diagram study-block"><picture><img className="study-light" src="/diagrams/fowoco-retrieval-decision.svg" width="1000" height="700" alt="고정 검색 관점과 핵심 정보 검사를 거쳐 Dense와 Sparse 검색, RRF 결합, 재정렬과 fallback으로 이어지는 검색 구조"/><img className="study-dark" src="/diagrams/fowoco-retrieval-decision-dark.svg" width="1000" height="700" alt="고정 검색 관점과 핵심 정보 검사, 검색 결합 및 재정렬 구조"/></picture><figcaption>검색 구조 개념도 · 실제 검색 실행 화면이 아닙니다.</figcaption></figure>
