...
export default function FowocoStudy(){
 ...
 <header className="fw-hero">
  ...
  <nav className="fw-toc" aria-label="상세 페이지 목차"><a href="#p-scope">배경과 담당</a><a href="#p-language">언어 처리</a><a href="#p-document">문서 자동화</a><a href="#p-reflection">회고</a></nav>

 <Part n="00" title="배경과 담당" id="p-scope"/>
 <section id="scope" className="fw-section">
  <Heading n="맡은 범위" title="언어 처리와 문서 자동화를 맡았습니다."/>
 ...
 <Part n="01" title="언어 처리" id="p-language"/>
 <section id="search" className="fw-section">
  <Heading n="검색 설계" title="업무 표현을 EPS 대응 자료에서 찾아 쓰기로 했습니다."/>
  <Facts items={[
 ...
 <section id="evidence" className="fw-section">
  <Heading n="검색 비교" title="검색 품질을 높이는 대신, 응답 시간은 얼마나 늘어나는가?"/>
 ...
 <section id="easy" className="fw-section">
  <Heading n="정보 보존" title="번역이 서류와 기한을 바꾸지 않았는지 검사합니다.">근로자는 안내를 읽고 준비할 서류와 제출 기한을 판단합니다.</Heading>
  <Facts items={[
 ...
 <Part n="02" title="문서 자동화" id="p-document"/>
 <section id="separation" className="fw-section">
  <Heading n="필드 매핑과 도구 분리" title="각 칸을 출처가 있는 값으로 채우고, 문서 기능은 밖으로 뺐습니다."/>
  <Facts items={[
 ...
 <section id="reflection" className="fw-section">
  <Heading n="다시 만든다면" title="검색 폭과 정보 보존, 어느 쪽이 더 문제였을까?"/>
  <Facts items={[
