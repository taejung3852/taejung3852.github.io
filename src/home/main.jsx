...
function App(){return <BrowserRouter><LocationEffects/><Header/><main id="main" tabIndex="-1"><Routes><Route path="/" element={<Home/>}/><Route path="/projects/fowoco" element={<FowocoStudy/>}/><Route path="/projects/hwpx" element={<HwpxStudy/>}/><Route path="/projects/ownhands" element={<OwnhandsStudy/>}/><Route path="/projects/llm-gateway" element={<GatewayStudy/>}/><Route path="/projects/:slug" element={<ProjectPlaceholder/>}/><Route path="*" element={<NotFound/>}/></Routes></main><PageFooter/></BrowserRouter>}
